...
(cl:defmethod cl:initialize-instance :after ((m <camera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ilk_paket-msg:<camera> is deprecated: use ilk_paket-msg:camera instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <camera>))
